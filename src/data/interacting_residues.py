...
def residues_interacting_with_ligand(ligand_expo_id):
    """
    For a query ligand, get all interacting residues across all available ligand-bound structures in KLIFS.
    ...
    ifp_series = session.interactions.by_ligand_klifs_id(ligand_klifs_id)["interaction.fingerprint"]
